          ...
          <aside className="hidden md:flex md:w-52 md:shrink-0 md:flex-col border-r-[5px] border-zinc-950">
            ...
            <div className="px-5 pt-8 pb-6">
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className="text-[20px] font-black uppercase tracking-widest text-zinc-950"
            ...
            <nav className="px-3 flex flex-col gap-0.5">
              ...
              >
                <span className="text-[13px]" style={isCapture ? {} : { color: 'inherit' }}>
                  ✦
                </span>
                Capture
              </Link>
          ...
          <div className="flex flex-1 flex-col min-w-0 min-h-0">
            ...
            <header className="md:hidden flex shrink-0 items-center justify-between border-b border-zinc-200 bg-white px-5 py-3.5">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[16px] font-black uppercase tracking-widest text-zinc-950">
                  PULSE
                </span>
              </div>
            ...
            >
              ...
              >
                <span
                  ...
                  style={isCapture ? { color: 'var(--neon)' } : {}}
                >
                  ✦
                </span>
                Capture
...
function StatBlock({ label, value }: { label: string; value: number | undefined }) {
  return (
    <div className="border-[3px] border-zinc-950 p-3 transition-all hover:bg-zinc-950 hover:text-white group">
      <div className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 group-hover:text-zinc-300 mb-1">
        {label}
      </div>
      <div className="font-mono font-black text-[26px] leading-none text-zinc-950 tabular-nums group-hover:text-white">
        {value ?? (
          <span className="inline-block h-5 w-5 animate-pulse rounded-sm bg-zinc-200 align-middle" />
        )}
      </div>
    </div>
  )
